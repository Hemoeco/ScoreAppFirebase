...
export async function saveRentEquip(equipRentData, isConnected) {
  ...
  if (isConnected) {
    ...
    id = response.data.name; //To get the id generated by Firebase.
  }
...
export function updateRentEquip(id, equipmentData, isConnected) {
  if (isConnected) {
    return axios.put(`${BACKEND_URL}/${TABLE_NAME}/${id}.json`, equipmentData);
  }
}

export function deleteRentEquip(id, isConnected) {
  if (isConnected) {
